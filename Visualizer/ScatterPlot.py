...
def Multi_Scatter(dataFrame, rows, cols_x, cols_y, kind='reg', diag_kind='hist', hue=None):
	'''
...
def Frequency_Map(dataFrame, rows, cols_x, cols_y, kind="kde"):
	'''
	:param dataFrame: The DataFrame need ploting
	:param rows: Rows you want to display in your chart:
			+ Pass a num: <row> to display one row
...
def Curly_Linear_Line(dataFrame, rows, cols_x, cols_y, hue=None):
	'''
	:param dataFrame: The DataFrame need ploting
	:param rows: Rows you want to display in your chart:
		+ Pass a num: <row> to display one row
